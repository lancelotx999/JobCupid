    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                ...
                <h3 class="text-capitalize" style="text-transform:uppercase;font-size:16px;">I need a job</h3>
            </div>
           ...
           <div class="col-xs-6">
                ...
                <h3 class="text-capitalize" style="text-transform:uppercase;font-size:16px;">I need a worker</h3>
            </div>
    </div>
    <div class="row">
